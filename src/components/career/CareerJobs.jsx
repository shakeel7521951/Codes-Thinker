...
const CareerJobs = () => {
  ...
  <div className="max-w-6xl mx-auto px-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
    {jobs.map((job, idx) => (
      <div
        key={idx}
        className="bg-gradient-to-b from-[#0D1A6A] to-[#192e9e] rounded-2xl p-6 shadow-xl text-white relative border border-purple-600 hover:scale-[1.02] transition min-h-[300px] flex flex-col justify-between"
      >
        <div>
