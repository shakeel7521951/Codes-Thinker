        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center text-left">
          ...
          <div className="px-2">
            ...
            <p className="text-base sm:text-lg mb-5 text-gray-900">
              ...
              design, and development. We help businesses grow by coming up with
              new ideas, being experts in our field, and always trying to be the
              best. We focus on cryptocurrency, blockchain, fintech, startups,
              small businesses, B2B, and much more. Welcome to a journey that
              will change you, where your goals will become our mission.
            </p>
          </div>
        </div>
      </section>
