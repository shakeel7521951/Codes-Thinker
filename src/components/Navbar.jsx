...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#060145] shadow-md py-2">
      ...
      {/* Mobile Menu */}
      {showMenu && (
        <div className="md:hidden bg-[#002E3D] text-white px-4 py-6 space-y-4">
          <div className="flex flex-col space-y-3">
            ...
            {showDropdown && (
              <div className="bg-white text-[#002f3f] rounded shadow-lg py-2 w-full">
            ...
            <a href="#" className="hover:border-t-2 hover:border-[#05C806] w-[13%]">About</a>
            <a href="#" className="hover:border-t-2 hover:border-[#05C806] w-[13%]">Giving</a>
            <a href="#" className="hover:border-t-2 hover:border-[#05C806] w-[13%]">Blog</a>
            <a href="#" className="hover:border-t-2 hover:border-[#05C806] w-[13%]">Contact</a>
          </div>
          ...
          <div className="flex flex-col space-y-4 pt-4">
            ...
            <button className="bg-[#05C806] hover:bg-[#038C04] transition rounded px-4 py-2 text-sm font-semibold w-full">
              Get Started For Free
            </button>
          </div>
        </div>
